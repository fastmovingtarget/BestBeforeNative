...
export const deleteInventoryItemData = async (
    ...
    let returnPromise = new Promise<UpdateState>((resolve) => {
        fetch(
            `https://bestbeforeapi.fastmovingtarget.co.uk/inventory/${inventoryItemID}`, 
            {
                method: "DELETE",
                headers: {
            ...
            if(rawData.ok) {
                ...
                log(`Error deleting inventory item with ID: ${inventoryItemID}: ${rawData.statusText}`, "error");
