...
jest.mock('@/components/Planner/PlannerActiveDay/PlannerActiveDayRecipes/PlannerActiveDayRecipes', () => {
    return {
        __esModule: true,
        default: jest.fn()
    };
});
jest.mock('@/components/Planner/PlannerActiveDay/PlannerIngredients/PlannerIngredients', () => {
    return {
        __esModule: true,
        default: jest.fn()
    };
